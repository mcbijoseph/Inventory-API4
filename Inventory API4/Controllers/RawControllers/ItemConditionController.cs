...
namespace Inventory_API4.Controllers.RawControllers
{
    ...
    public class ItemConditionController : ApiController
    {
        ...
        [AuthRoleAccess("ItemConditions", "Insert")]
        ...
        [DomainValidatorFilter]
        [ResponseType(typeof(MessageViewDomain))]
        [AuthRoleAccess("ItemCondition", "Update")]
        ...
        /// <returns></returns>
        [ResponseType(typeof(MessageViewDomain))]
        [AuthRoleAccess("ItemCondition", "Delete")]
        ...
        [AuthRoleAccess("ItemCondition", "SelectList")]
        ...
        [AuthRoleAccess("ItemCondition", "Select")]
