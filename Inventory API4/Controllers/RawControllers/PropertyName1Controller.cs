...
namespace Inventory_API4.Controllers
{
    ...
    public class PropertyName1Controller : ApiController
    {
        ...
        [AuthRoleAccess("PropertyName1", "Insert")]
        ...
        [DomainValidatorFilter]
        [ResponseType(typeof(MessageViewDomain))]
        [AuthRoleAccess("PropertyName1", "Update")]
        ...
        /// <returns></returns>
        [ResponseType(typeof(MessageViewDomain))]
        [AuthRoleAccess("PropertyName1", "Delete")]
        ...
        [AuthRoleAccess("PropertyName1", "SelectList")]
        ...
        [AuthRoleAccess("PropertyName1", "Select")]
