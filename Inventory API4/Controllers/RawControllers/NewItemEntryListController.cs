...
namespace Inventory_API4.Controllers
{
    ...
    public class NewItemEntryListController : ApiController
    {
        ...
        [Auth("POST", "NewItemEntryList", "Insert")]
        ...
        [DomainValidatorFilter]
        [ResponseType(typeof(MessageViewDomain))]
        [Auth("PUT", "NewItemEntryList", "Update")]
        ...
        /// <returns></returns>
        [ResponseType(typeof(MessageViewDomain))]
        [Auth("DELETE", "NewItemEntryList", "Delete")]
        ...
        [Auth("GET", "NewItemEntryList", "SelectList")]
        ...
        [Auth("GET", "NewItemEntryList", "Select")]
