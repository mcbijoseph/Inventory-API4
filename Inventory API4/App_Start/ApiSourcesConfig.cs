...
namespace Inventory_API4.App_Start
{
    public class ApiSourcesConfig
    {
        ...
        public static void Config()
        {
            ...
            //Inventory_API4.Models.ApiReferenceHolder.supplierArray = Newtonsoft.Json.JsonConvert.DeserializeObject<JArray>(new Helper.SynchronousRequest("http://124.105.198.3:99/api/supplier/0").HttpRequest());
