...
namespace InventoryBL
{
    ...
    public class _010_invRefDeliveryMethodBL : Common.BaseBL, I_010_invRefDeliveryMethodBL<_010_invRefDeliveryMethodDomain>
    {
        ...
        public MessageViewDomain Delete(int id)
        {
            ...
            return Command(new _010_invRefDeliveryMethodDomain() { ID = id }, Inventory_API4.Models.Command.Delete);
        }
        ...
        public IEnumerable<_010_invRefDeliveryMethodDomain> GetData(int id)
        {
            ...
            string tabledata = _dbHelper.GetRecords("sp010invRefDeliveryMethodSelect", pars).Tables[0].Rows[0][0].ToString();//, Newtonsoft.Json.Formatting.None);
            return JsonConvert.DeserializeObject<List<_010_invRefDeliveryMethodDomain>>(tabledata);
        }
    }
}
