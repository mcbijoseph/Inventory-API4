    ...
    public class _002_invRefCategory2BL : Common.BaseBL, I_002_invRefCategory2BL<_002_invRefCategory2Domain>
    {
        ...
        public MessageViewDomain Command(_002_invRefCategory2Domain projectDomain, Command commandType)
        {
            ...
            var sqlParameters = new List<SqlParameter>()
            {
                ...
                new SqlParameter { ParameterName = "@Cat1ID_001", Value = projectDomain.Cat1ID_001, Direction = ParameterDirection.Input }

            };

            return this.GetMessage(_dbHelper.Command("sp002invRefCategory2Command", commandType.ToString(), sqlParameters).Tables[0]);
        ...
        public MessageViewDomain Delete(int id)
        {
            ...
            return Command(new _002_invRefCategory2Domain() { ID = id }, Inventory_API4.Models.Command.Delete);
        }
