...
namespace InventoryBL
{
    ...
    public interface I_001_invRefCategory1BL<TEntity> : InventoryBL.Common.IBaseBL<TEntity> where TEntity : class
    {
    ...
    public class _001_invRefCategory1BL : Common.BaseBL, I_001_invRefCategory1BL<_001_invRefCategory1Domain>
    {
        ...
        public MessageViewDomain Delete(int id)
        {
            ...
            return Command(new _001_invRefCategory1Domain() { ID = id }, Inventory_API4.Models.Command.Delete);
        }
