...
namespace InventoryBL
{
    ...
    public class _022_invTransferedItemsDetailsBL : Common.BaseBL, I_022_invTransferedItemsDetailsBL<_022_invTransferedItemsDetailsDomain>
    {
        ...
        public MessageViewDomain Command(_022_invTransferedItemsDetailsDomain projectDomain, string commandType)
        {
            ...
            return this.GetMessage(_dbHelper.Command("sp022invTransferedItemsDetailsCommand", commandType, sqlParameters).Tables[0]);
        ...
        public MessageViewDomain Delete(int id)
        {
            ...
            return Command(new _022_invTransferedItemsDetailsDomain() { ID = id }, "delete");
        }
