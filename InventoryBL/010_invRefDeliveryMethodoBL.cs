...
namespace InventoryBL
{
    ...
    public class _010_invRefDeliveryMethodBL : Common.BaseBL, I_010_invRefDeliveryMethodBL<_010_invRefDeliveryMethodDomain>
    {
        ...
        public MessageViewDomain Command(_010_invRefDeliveryMethodDomain projectDomain, string commandType)
        {
            ...
            return this.GetMessage(_dbHelper.Command("sp010invRefDeliveryMethodCommand", commandType, sqlParameters).Tables[0]);
        ...
        public MessageViewDomain Delete(int id)
        {
            ...
            return Command(new _010_invRefDeliveryMethodDomain() { ID = id }, "delete");
        }
