...
namespace InventoryBL
{
    ...
    public class _017_invDeliveryMethodEntryListBL : Common.BaseBL, I_017_invDeliveryMethodEntryListBL<_017_invDeliveryMethodEntryListDomain>
    {
        ...
        public MessageViewDomain Command(_017_invDeliveryMethodEntryListDomain projectDomain, Command commandType)
        {
            ...
            return this.GetMessage(_dbHelper.Command("sp017invDeliveryMethodEntryListCommand", commandType.ToString(), sqlParameters).Tables[0]);
        ...
        public MessageViewDomain Delete(int id)
        {
            ...
            return Command(new _017_invDeliveryMethodEntryListDomain() { ID = id }, Inventory_Domain_Layer.Command.Delete);
        }
