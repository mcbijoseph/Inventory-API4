...
namespace InventoryBL
{
    ...
    public class _020_invReleasedItemDetailsBL : Common.BaseBL, I_020_invReleasedItemDetailsBL<_020_invReleasedItemDetailsDomain>
    {
        ...
        public MessageViewDomain Command(_020_invReleasedItemDetailsDomain projectDomain, string commandType)
        {
            ...
            return this.GetMessage(_dbHelper.Command("sp020invReleasedItemDetailsCommand", commandType, sqlParameters).Tables[0]);
        ...
        public MessageViewDomain Delete(int id)
        {
            ...
            return Command(new _020_invReleasedItemDetailsDomain() { ID = id }, "delete");
        }
